...
class Stubs {
  static Future<NewsModel> getFutureNewsModel() async {
    ...
    return {
      {
        ...
        "hdurl":
            "https://apod.nasa.gov/apod/image/2203/noirlab2209a_ngc772.jpg",
        "media_type": "image",
        "service_version": "v1",
        "title": "Arp 78: Peculiar Galaxy in Aries",
        "url":
            "https://apod.nasa.gov/apod/image/2203/noirlab2209a_ngc772_1024.jpg"
      }
    };
  }
